...
while True:
	...
	while len(queue_of_plans) > 0:
		...
		# queue_of_plans = queue_of_plans[:500]
	...
	new_priority_queue, graph_guru = update_priority_queue(queue_of_plans, nodes_to_change, graph_guru, END_NODE, START_NODE, operator_costs, old_min, new_min, previous_opt_graph)
