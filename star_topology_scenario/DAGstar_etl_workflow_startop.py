...
json_file_path = "network/etl/" + str(my_conf_number) + "/network_" + str(my_conf_number) + "_1_star.json"  # Provide the path to your JSON file
...
json_file_path = "network/etl/" + str(my_conf_number) + "/links_" + str(my_conf_number) + "_1.json"  # Provide the path to your JSON file
...
codes_dictionary = {
	...
	'source': {
		'possible_locations_lst': [site_names[1]],
		'possible_frameworks_lst': ['BDP__1111']
	},
	'END': {
...
for i in range(rows):
	row = []
	for j in range(cols):
		row.append(code11_costs[1] * mult_factor)
