...
##########################################
# Complex graph
graph.add_node(1, 0, 0, 'CODE1', 'dummy0', 'dummy0')
graph.add_node(2, 0, 0, 'CODE2', 'dummy0', 'dummy0')
graph.add_node(3, 0, 0, 'CODE3', 'dummy0', 'dummy0')
graph.add_node(4, 0, 0, 'CODE4', 'dummy0', 'dummy0')
graph.add_node(5, 0, 0, 'CODE5', 'dummy0', 'dummy0')
graph.add_node(6, 0, 0, 'CODE6', 'dummy0', 'dummy0')
graph.add_node(7, 0, 0, 'CODE7', 'dummy0', 'dummy0')
graph.add_node(8, 0, 0, 'CODE8', 'dummy0', 'dummy0')
graph.add_node(9, 0, 0, 'CODE9', 'dummy0', 'dummy0')
graph.add_node(10, 0, 0, 'CODE10', 'dummy0', 'dummy0')
graph.add_node(11, 0, 0, 'CODE11', 'dummy0', 'dummy0')
...
while True:
	...
	change_lst = [0.01, 0.1, 10, 10, 0.1, 100]
	...
	# 	# The modeled change is the addition of a new option for the location of CODE2 operators
